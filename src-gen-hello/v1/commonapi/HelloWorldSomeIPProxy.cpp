...
HelloWorldSomeIPProxy::HelloWorldSomeIPProxy(
    ...
    const std::shared_ptr<CommonAPI::SomeIP::ProxyConnection> &_connection)
        : CommonAPI::SomeIP::Proxy(_address, _connection),
          helloState_(*this, CommonAPI::SomeIP::eventgroup_id_t(0x1001), CommonAPI::SomeIP::event_id_t(0xa005), CommonAPI::SomeIP::method_id_t(0x2007), false, CommonAPI::SomeIP::reliability_type_e::RT_UNRELIABLE, false, static_cast< CommonAPI::EmptyDeployment* >(nullptr)),
          helloBroadcast_(*this, 0x1002, CommonAPI::SomeIP::event_id_t(0x8235), CommonAPI::SomeIP::event_type_e::ET_EVENT , CommonAPI::SomeIP::reliability_type_e::RT_UNRELIABLE, false, std::make_tuple(static_cast< CommonAPI::SomeIP::StringDeployment* >(nullptr)))
{
}
